...
/*!
* \brief implementation of the wrapper for the pCMF algorithm based on the sparse Gamma-Poisson factor model
...
//' @export
// [[Rcpp::export]]
SEXP run_sparse_gap_factor(SEXP X, int K, double sel_bound = 0.5,
    ...
    Rcpp::List output = wrapper_sparse_gap_factor<sparse_gap_factor_model, variational_em_algo>(X, K, sel_bound, U, V, verbose, monitor,
