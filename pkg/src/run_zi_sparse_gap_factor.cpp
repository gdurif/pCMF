...
/*!
* \brief implementation of the wrapper for the pCMF algorithm based on the Zero-inflated sparse Gamma-Poisson factor model
...
//' @export
// [[Rcpp::export]]
SEXP run_zi_sparse_gap_factor(SEXP X, int K, double sel_bound = 0.5,
