...
run_sparse_gap_factor <- function(X, K, sel_bound = 0.5, U = NULL, V = NULL, verbose = TRUE, monitor = TRUE, iter_max = 1000L, iter_min = 500L, init_mode = "random", epsilon = 1e-2, additional_iter = 10L, conv_mode = 1L, ninit = 1L, iter_init = 100L, ncores = 1L, reorder_factor = TRUE, seed = NULL, a1 = NULL, a2 = NULL, b1 = NULL, b2 = NULL, alpha1 = NULL, alpha2 = NULL, beta1 = NULL, beta2 = NULL) {
    .Call(`_pCMF_run_sparse_gap_factor`, X, K, sel_bound, U, V, verbose, monitor, iter_max, iter_min, init_mode, epsilon, additional_iter, conv_mode, ninit, iter_init, ncores, reorder_factor, seed, a1, a2, b1, b2, alpha1, alpha2, beta1, beta2)
}
...
run_zi_gap_factor <- function(X, K, U = NULL, V = NULL, verbose = TRUE, monitor = TRUE, iter_max = 1000L, iter_min = 500L, init_mode = "random", epsilon = 1e-2, additional_iter = 10L, conv_mode = 1L, ninit = 1L, iter_init = 100L, ncores = 1L, reorder_factor = TRUE, seed = NULL, a1 = NULL, a2 = NULL, b1 = NULL, b2 = NULL, alpha1 = NULL, alpha2 = NULL, beta1 = NULL, beta2 = NULL) {
    .Call(`_pCMF_run_zi_gap_factor`, X, K, U, V, verbose, monitor, iter_max, iter_min, init_mode, epsilon, additional_iter, conv_mode, ninit, iter_init, ncores, reorder_factor, seed, a1, a2, b1, b2, alpha1, alpha2, beta1, beta2)
}
...
run_zi_sparse_gap_factor <- function(X, K, sel_bound = 0.5, U = NULL, V = NULL, verbose = TRUE, monitor = TRUE, iter_max = 1000L, iter_min = 500L, init_mode = "random", epsilon = 1e-2, additional_iter = 10L, conv_mode = 1L, ninit = 1L, iter_init = 100L, ncores = 1L, reorder_factor = TRUE, seed = NULL, a1 = NULL, a2 = NULL, b1 = NULL, b2 = NULL, alpha1 = NULL, alpha2 = NULL, beta1 = NULL, beta2 = NULL) {
    .Call(`_pCMF_run_zi_sparse_gap_factor`, X, K, sel_bound, U, V, verbose, monitor, iter_max, iter_min, init_mode, epsilon, additional_iter, conv_mode, ninit, iter_init, ncores, reorder_factor, seed, a1, a2, b1, b2, alpha1, alpha2, beta1, beta2)
}
