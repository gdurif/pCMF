...
#' @title start_profiler
#' @name start_profiler
#'
#' @description
#' Start the profiler from gperftools
#'
#' @details
#' To enable the profiling functions, you need to install the gperftools
#' library on your machine. You need to append the following flags to the
#' `PKG_CXXFLAGS` field in the `src/Makevars` file:
#' * `-I/path/to/gpertool_library`: generally `-I/usr/include`
#' * `-D_PROF`
#' You also need to append the option `-lprofiler` to the `PKG_LIBS` field
...
#'
#' @param str filename where the profiling trace will be stored.
#'
#' @return a NULL value
#'
#' @seealso \code{\link{stop_profiler}}
#'
#' @export
start_profiler <- function(str) {
    .Call(`_pCMF_start_profiler`, str)
}
...
#'
#' @description
#' Stop the profiler from gperftools
#'
#' @details
#' To enable the profiling functions, you need to install the gperftools
#' library on your machine. You need to append the following flags to the
...
#' @return a NULL value
#'
#' @seealso \code{\link{start_profiler}}
#'
#' @export
stop_profiler <- function() {
    .Call(`_pCMF_stop_profiler`)
}

#' @title profile_matprod_col
#' @name profile_matprod_col
#'
#' @description
#' Compute matrix product \code{U * t(V)} where dimension of \code{U} is
#' \code{n x K}, dimension of \code{V} is \code{p x K}, and Eigen
#' matrices use a column major storage.
#'
#' @details
#' This function can be used in association with \code{\link{start_profiler}}
#' and \code{\link{stop_profiler}} to do some profiling on the matrix product
#' described above.
#'
#' @author
#' Ghislain Durif, \email{gd.dev@libertymail.net}
#'
#' @param n intger, number of rows of matrix \code{U}.
#' @param p intger, number of rows of matrix \code{V}.
#' @param K intger, number of columns of both matrices \code{U} and \code{V}.
#'
#' @return a NULL value
#'
#' @export
profile_matprod_col <- function(n, p, K) {
    .Call(`_pCMF_profile_matprod_col`, n, p, K)
}

#' @title profile_matprod_row
#' @name profile_matprod_row
#'
#' @description
#' Compute matrix product \code{U * t(V)} where dimension of \code{U} is
#' \code{n x K}, dimension of \code{V} is \code{p x K}, and Eigen
#' matrices use a row major storage.
#'
#' @details
#' This function can be used in association with \code{\link{start_profiler}}
#' and \code{\link{stop_profiler}} to do some profiling on the matrix product
...
#'
#' @export
profile_matprod_row <- function(n, p, K) {
    .Call(`_pCMF_profile_matprod_row`, n, p, K)
}
